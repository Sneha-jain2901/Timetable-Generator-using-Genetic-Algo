...
public class Add_Rooms extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Seating Capacity");
    ...
    private void AddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddActionPerformed
        ...
        int seatingCapacity = Integer.parseInt(jTextField2.getText());

        // Create a Room object with user input
        Room newRoom = new Room(roomID, seatingCapacity);
        App.data.addRoom(newRoom);
